...
//document.write('<link rel="manifest" href="">'); //PWA需要設定的東西 需要另外設定
...
// DPlayer API
document.write('<script src="//cdn.jsdelivr.net/combine/gh/jquery/jquery@3.2/dist/jquery.min.js,gh/moosetk/goindex@${authConfig.version}/ANiopen/DPlayer.min.js"></script>');
...
function nav(path) {
    var html = "";
    html += `<div style="max-width:150px;"><img class="mdui-typo-headline mdui-img-fluid folder" href="/"  style = "max-width: 100%;height: auto;width: auto;"src="[icon網址]"></div>`; //設定網頁ICON
    ...
    <a href="[Telegram網址]" target="_blank" class="mdui-btn mdui-btn-icon mdui-ripple mdui-ripple-white" mdui-tooltip="{content: 'Telegram'}">
